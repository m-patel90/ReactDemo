    ...
    if ($("#desktop-chart").length) {
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          var text = [];
          text.push('<div className="d-flex align-items-center mb-3">');
            text.push('<div className="mr-2" style="width: 10px; height: 10px; border-radius: 50%;  background: ' + chart.data.datasets[0]. backgroundColor[0] + ' "></div>');
            text.push('<p className="mb-0">Desktop&nbsp;(24%)</p>')
          text.push('</div>');
          text.push('<div className="d-flex align-items-center mb-3">');
            text.push('<div className="mr-2" style="width: 10px; height: 10px; border-radius: 50%; background: ' + chart.data.datasets[0]. backgroundColor[1] + ' "></div>');
            text.push('<p className="mb-0">Mobile&nbsp;(26%)</p>')
          text.push('</div>');
          text.push('<div className="d-flex align-items-center">');
            text.push('<div className="mr-2" style="width: 10px; height: 10px; border-radius: 50%; background: ' + chart.data.datasets[0]. backgroundColor[2] + ' "></div>');
